...
{
	if (region.ag.N === region.an.N)
	{
		return 'on line ' + region.ag.N;
	}
	return 'on lines ' + region.ag.N + ' through ' + region.an.N;
}
...
function _Browser_visibilityInfo()
{
	return (typeof _VirtualDom_doc.hidden !== 'undefined')
		? { aW: 'hidden', aM: 'visibilitychange' }
		:
	(typeof _VirtualDom_doc.mozHidden !== 'undefined')
		? { aW: 'mozHidden', aM: 'mozvisibilitychange' }
		:
	(typeof _VirtualDom_doc.msHidden !== 'undefined')
		? { aW: 'msHidden', aM: 'msvisibilitychange' }
		:
	(typeof _VirtualDom_doc.webkitHidden !== 'undefined')
		? { aW: 'webkitHidden', aM: 'webkitvisibilitychange' }
		: { aW: 'hidden', aM: 'visibilitychange' };
}
...
var author$project$Main$ArenaDimensions = F3(
	function (unitSize, cols, rows) {
		return {U: cols, V: rows, X: unitSize};
	});
...
var author$project$Main$initialSnake = {
	h: A2(
		elm$core$List$map,
		function (y) {
			return A2(author$project$Main$Position, 15, y);
		},
		A2(elm$core$List$range, 13, 18)),
	B: 2,
	s: _List_Nil
};
var author$project$Main$initialModel = {
	l: A3(author$project$Main$ArenaDimensions, 18, 30, 18),
	M: A2(author$project$Main$Position, 15, 3),
	w: 0,
	r: 0,
	j: author$project$Main$initialSnake
};
...
var author$project$Main$Move = {$: 0};
var author$project$Main$TimePenalty = {$: 3};
...
var author$project$Main$speedPerSecond = function (score) {
	return 10 + ((score / 250) | 0);
};
...
var elm$time$Time$State = F2(
	function (taggers, processes) {
		return {aA: processes, aI: taggers};
	});
...
var author$project$Main$subscriptions = function (model) {
	var timePenaltySub = A2(
		elm$time$Time$every,
		1000,
		function (_n2) {
			return author$project$Main$TimePenalty;
		});
	var moveSub = A2(
		elm$time$Time$every,
		1000 / author$project$Main$speedPerSecond(model.r),
		function (_n1) {
			return author$project$Main$Move;
		});
	var keyPressedSub = elm$browser$Browser$Events$onKeyDown(author$project$Main$keyPressedDecoder);
	var _n0 = model.w;
	if (!_n0) {
		return elm$core$Platform$Sub$batch(
			_List_fromArray(
				[moveSub, timePenaltySub, keyPressedSub]));
	} else {
		return keyPressedSub;
	}
};
var author$project$Main$EndGame = {$: 6};
var author$project$Main$FruitEaten = {$: 2};
var author$project$Main$GameOver = 1;
var author$project$Main$Restart = {$: 7};
...
var author$project$Main$directionFromKey = function (key) {
	switch (key) {
		case 'w':
...
var author$project$Main$enqueueTurn = F2(
...
var author$project$Main$NewFruit = function (a) {
	return {$: 1, a: a};
};
...
var author$project$Main$fruitGenerator = function (_n0) {
	var cols = _n0.U;
	var rows = _n0.V;
	return A3(
		elm$random$Random$map2,
		author$project$Main$Position,
		A2(elm$random$Random$int, 1, cols),
		A2(elm$random$Random$int, 1, rows));
};
...
var author$project$Main$generateFruit = function (dims) {
	return A2(
		elm$random$Random$generate,
		author$project$Main$NewFruit,
		author$project$Main$fruitGenerator(dims));
};
var author$project$Main$Collision = {$: 2};
var author$project$Main$Moved = function (a) {
	return {$: 0, a: a};
};
var author$project$Main$MovedAndFed = function (a) {
	return {$: 1, a: a};
};
var author$project$Main$toArenaPosition = F2(
	function (dimensions, _n0) {
		var col = _n0.n;
		var row = _n0.q;
		var bounded = F2(
			function (limit, v) {
				return (_Utils_cmp(v, limit) > 0) ? 1 : ((v < 1) ? limit : v);
			});
		return {
			n: A2(bounded, dimensions.U, col),
			q: A2(bounded, dimensions.V, row)
		};
	});
var author$project$Main$decrement = function (val) {
	return val - 1;
};
var author$project$Main$increment = function (val) {
	return val + 1;
};
var author$project$Main$transformPosition = F2(
		...
		switch (direction) {
			case 0:
				return _Utils_update(
					position,
					{
						n: author$project$Main$increment(position.n)
					});
			case 1:
				return _Utils_update(
					position,
					{
						n: author$project$Main$decrement(position.n)
					});
			case 2:
				return _Utils_update(
					position,
					{
						q: author$project$Main$decrement(position.q)
					});
			default:
				return _Utils_update(
					position,
					{
						q: author$project$Main$increment(position.q)
					});
		}
	});
var author$project$Main$opposite = function (dir) {
	switch (dir) {
		case 0:
			return 1;
		case 1:
...
var author$project$Main$turnSnake = function (snake) {
	turnSnake:
	while (true) {
		var _n0 = elm$core$List$head(snake.s);
		if (!_n0.$) {
			var nextDir = _n0.a;
			var queue = A2(elm$core$List$drop, 1, snake.s);
			var isTurnValid = (!_Utils_eq(
				nextDir,
				author$project$Main$opposite(snake.B))) && (!_Utils_eq(nextDir, snake.B));
			if (isTurnValid) {
				return _Utils_update(
					snake,
					{B: nextDir, s: queue});
			} else {
				var $temp$snake = _Utils_update(
					snake,
					{s: queue});
				snake = $temp$snake;
				continue turnSnake;
...
var author$project$Main$validateCollisions = function (snake) {
	var _n0 = snake.h;
	if (_n0.b) {
		var head = _n0.a;
		var tail = _n0.b;
		return A2(elm$core$List$member, head, tail) ? elm$core$Maybe$Nothing : elm$core$Maybe$Just(snake);
	} else {
		return elm$core$Maybe$Nothing;
	}
};
...
var author$project$Main$moveSnake = F3(
	function (dimensions, fruit, snake) {
		var turnedSnake = author$project$Main$turnSnake(snake);
		var maybeNextHead = A2(
			elm$core$Maybe$map,
			author$project$Main$toArenaPosition(dimensions),
			A2(
				elm$core$Maybe$map,
				author$project$Main$transformPosition(turnedSnake.B),
				elm$core$List$head(snake.h)));
		var snakeFed = A2(
			elm$core$Maybe$withDefault,
			false,
			A2(
				elm$core$Maybe$map,
				elm$core$Basics$eq(fruit),
				maybeNextHead));
		var adjustBody = snakeFed ? elm$core$Basics$identity : elm$core$List$take(
			elm$core$List$length(snake.h));
		var maybeNextSnake = A2(
			elm$core$Maybe$andThen,
			author$project$Main$validateCollisions,
			A2(
				elm$core$Maybe$map,
				function (body) {
					return _Utils_update(
				...
				A2(
					...
					A2(
						elm$core$Maybe$map,
						function (head) {
							return A2(elm$core$List$cons, head, snake.h);
						},
						maybeNextHead))));
		var _n0 = _Utils_Tuple2(maybeNextSnake, snakeFed);
		if (!_n0.a.$) {
			if (_n0.b) {
				var nextSnake = _n0.a.a;
				return author$project$Main$MovedAndFed(nextSnake);
			} else {
				var nextSnake = _n0.a.a;
				return author$project$Main$Moved(nextSnake);
			}
		} else {
			var _n1 = _n0.a;
			return author$project$Main$Collision;
		}
	});
var author$project$Main$update = F2(
	function (msg, model) {
		switch (msg.$) {
			...
			case 2:
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{r: model.r + 10}),
					author$project$Main$generateFruit(model.l));
			case 3:
				return _Utils_Tuple2(
					_Utils_update(
						model,
					...
					elm$core$Platform$Cmd$none);
			case 0:
				var moveResult = A3(author$project$Main$moveSnake, model.l, model.M, model.j);
				switch (moveResult.$) {
					case 2:
						return A2(author$project$Main$update, author$project$Main$EndGame, model);
					case 0:
						var nextSnake = moveResult.a;
						return _Utils_Tuple2(
							_Utils_update(
								model,
								{j: nextSnake}),
					...
					default:
						...
						return A2(
							...
							author$project$Main$FruitEaten,
							_Utils_update(
								model,
								{j: nextSnake}));
				}
			case 1:
				var fruit = msg.a;
				return A2(elm$core$List$member, fruit, model.j.h) ? _Utils_Tuple2(
					model,
					author$project$Main$generateFruit(model.l)) : _Utils_Tuple2(
					_Utils_update(
						model,
						{M: fruit}),
					elm$core$Platform$Cmd$none);
			case 4:
				...
				var _n2 = model.w;
				if (!_n2) {
					var _n3 = author$project$Main$directionFromKey(key);
					if (!_n3.$) {
						var dir = _n3.a;
						return A2(
							author$project$Main$update,
							author$project$Main$Turn(dir),
							model);
					} else {
					...
					if (key === ' ') {
						return A2(author$project$Main$update, author$project$Main$Restart, model);
					} else {
						return _Utils_Tuple2(model, elm$core$Platform$Cmd$none);
					}
				}
			default:
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							j: A2(author$project$Main$enqueueTurn, direction, model.j)
						}),
					elm$core$Platform$Cmd$none);
		}
	});
				...
				switch (setting.$) {
					case 0:
						...
						return _Utils_update(
							r,
							{
								u: A2(elm$core$List$cons, cmd, r.u)
							});
					case 1:
						var cmds = setting.a;
						return _Utils_update(
							r,
							{
								u: A3(elm$core$List$foldl, elm$core$List$cons, r.u, cmds)
							});
					case 3:
						var f = setting.a;
						return _Utils_update(
...
var joakin$elm_canvas$Canvas$shapes = F2(
	function (settings, ss) {
		return A2(
			...
			{
				u: _List_Nil,
				K: joakin$elm_canvas$Canvas$NotSpecified,
				L: joakin$elm_canvas$Canvas$DrawableShapes(ss)
			});
	});
var author$project$Main$renderBackground = F3(
...
var author$project$Main$renderSquare = F2(
	function (size, point) {
		return A3(joakin$elm_canvas$Canvas$rect, point, size, size);
	});
...
var author$project$Main$toPoint = F2(
	function (_n0, _n1) {
		var unitSize = _n0.X;
		var col = _n1.n;
		var row = _n1.q;
		var transform = A2(
			...
			author$project$Main$decrement,
			A2(
				elm$core$Basics$composeR,
				elm$core$Basics$mul(unitSize),
				elm$core$Basics$toFloat));
		return _Utils_Tuple2(
			transform(col),
			transform(row));
	});
var author$project$Main$renderTile = F2(
	function (dims, coords) {
		return A2(
			author$project$Main$renderSquare,
			dims.X,
			A2(author$project$Main$toPoint, dims, coords));
	});
...
var author$project$Main$renderFruit = function (_n0) {
	var fruit = _n0.M;
	var arenaDimensions = _n0.l;
	return A2(
		joakin$elm_canvas$Canvas$shapes,
		_List_fromArray(
			[
				joakin$elm_canvas$Canvas$fill(
				A3(avh4$elm_color$Color$rgb, 0.99, 0.91, 0.13))
			]),
		_List_fromArray(
			[
				A2(author$project$Main$renderTile, arenaDimensions, fruit)
			]));
};
var author$project$Main$snakeColor = function (state) {
	if (!state) {
		return A3(avh4$elm_color$Color$rgb, 0.38, 0.7, 0.8);
	} else {
		return A3(avh4$elm_color$Color$rgb, 0.1, 0.1, 0.1);
	}
};
var author$project$Main$renderSnake = function (model) {
	return A2(
		joakin$elm_canvas$Canvas$shapes,
		_List_fromArray(
			[
				joakin$elm_canvas$Canvas$fill(
				author$project$Main$snakeColor(model.w))
			]),
		A2(
			elm$core$List$map,
			author$project$Main$renderTile(model.l),
			model.j.h));
};
...
var joakin$elm_canvas$Canvas$renderTextFill = F5(
	function (txt, x, y, color, cmds) {
		return A2(
			elm$core$List$cons,
			A4(joakin$elm_canvas$Canvas$Internal$fillText, txt.W, x, y, txt.O),
			A2(
				elm$core$List$cons,
...
var joakin$elm_canvas$Canvas$renderTextStroke = F5(
	function (txt, x, y, color, cmds) {
		return A2(
			elm$core$List$cons,
			A4(joakin$elm_canvas$Canvas$Internal$strokeText, txt.W, x, y, txt.O),
			A2(
				elm$core$List$cons,
...
var author$project$Main$gameArenaView = function (model) {
	var canvasStyles = _List_fromArray(
		[
	...
	return A3(
		...
		_List_fromArray(
			[
				A3(author$project$Main$renderBackground, width, height, avh4$elm_color$Color$black),
				author$project$Main$renderFruit(model),
				author$project$Main$renderSnake(model)
			]));
};
...
var author$project$Main$gameoverView = function (state) {
	if (state === 1) {
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							elm$html$Html$text('Hit space to go again')
						]))
				]));
	} else {
...
var author$project$Main$headerView = function (score) {
	...
	var scoreStyles = _List_fromArray(
		[
...
var author$project$Main$view = function (model) {
	return A2(
		...
		_List_fromArray(
			[
				author$project$Main$headerView(model.r),
				author$project$Main$gameoverView(model.w),
				author$project$Main$gameArenaView(model)
			]));
};
var elm$browser$Browser$element = _Browser_element;
var author$project$Main$main = elm$browser$Browser$element(
	{aY: author$project$Main$init, a8: author$project$Main$subscriptions, ba: author$project$Main$update, bc: author$project$Main$view});
